...
<nav class="navbar navbar-expand-lg navbar-dark app-navbar">
  <div class="container-fluid">
    <a class="navbar-brand fw-bold" href="<?= url('/dashboard.php') ?>">⚽ Fantacalcio Asta</a>
    ...
    <div class="collapse navbar-collapse" id="navMain">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="<?= url('/profile.php') ?>">Il mio Team</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= url('/join-auction.php') ?>">Entra in asta</a></li>
        <?php if (Auth::isAdmin()): ?>
        <li class="nav-item"><a class="nav-link" href="<?= url('/admin/index.php') ?>">Admin</a></li>
        <?php endif; ?>
      </ul>
      <span class="navbar-text me-3">👤 <?= e(Auth::nickname() ?? '') ?></span>
      <a href="<?= url('/logout.php') ?>" class="btn btn-outline-light btn-sm">Esci</a>
    </div>
  </div>
</nav>
<?php endif; ?>
